...
// example usage -- this will ssh into network_machine_name, and form there connect the database to your machine.
start_server('network_machine_name', 'mysql_server_name', 3306);