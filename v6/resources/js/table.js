...
// Each button.deleteMe gets an event listener on click that will delete that row from table
...
// Script to update the "time remaining" in the date column of table
...
// On page load, get all Date cells and call "addTimeUntil" for each one to update them every second
...
// Script to set sale upon click of "set sale" button on contactlog page
...
// Script to end sale upon click of "end sale" button on contactlog page
